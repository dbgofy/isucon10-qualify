...
func getEstateDetail(c echo.Context) error {
	...
	var estate Estate
	err = db.Get(&estate, "SELECT id, thumbnail, name, description, latitude, longtitude, address, rent, door_height, door_width, features, popularity FROM estate WHERE id = ?", id)
	if err != nil {
...
func searchEstates(c echo.Context) error {
	...
	searchQuery := "SELECT id, thumbnail, name, description, latitude, longtitude, address, rent, door_height, door_width, features, popularity FROM estate WHERE "
...
func getLowPricedEstate(c echo.Context) error {
	...
	query := `SELECT id, thumbnail, name, description, latitude, longtitude, address, rent, door_height, door_width, features, popularity FROM estate ORDER BY rent ASC, id ASC LIMIT ?`
...
func searchRecommendedEstateWithChair(c echo.Context) error {
	...
	query = `SELECT id, thumbnail, name, description, latitude, longtitude, address, rent, door_height, door_width, features, popularity FROM estate WHERE (door_min >= ? AND door_max >= ?) ORDER BY popularity DESC, id ASC LIMIT ?`
...
func searchEstateNazotte(c echo.Context) error {
	...
	query := `SELECT id, thumbnail, name, description, latitude, longtitude, address, rent, door_height, door_width, features, popularity FROM estate WHERE latitude <= ? AND latitude >= ? AND longitude <= ? AND longitude >= ? ORDER BY popularity DESC, id ASC`
	...
	for _, estate := range estatesInBoundingBox {
		...
		query := fmt.Sprintf(`SELECT id, thumbnail, name, description, latitude, longtitude, address, rent, door_height, door_width, features, popularity FROM estate WHERE id = ? AND ST_Contains(ST_PolygonFromText(%s), ST_GeomFromText(%s))`, coordinates.coordinatesToText(), point)
...
func postEstateRequestDocument(c echo.Context) error {
	...
	estate := Estate{}
	query := `SELECT id, thumbnail, name, description, latitude, longtitude, address, rent, door_height, door_width, features, popularity FROM estate WHERE id = ?`
